...
let inventors1500 = inventors.filter(inventor => {
...
let inventorsNames = inventors.map(inventor => `${inventor.first} ${inventor.last}`);
console.log("2. Give us an array of the inventors first and last names");
console.table(inventorsNames);

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
let inventorsBirthdate = inventors.sort((a, b) => a.year - b.year);
...
let inventorsYearsLived = inventors.sort((a, b) => (b.passed - b.year) - (a.passed - a.year));
console.log("5. Sort the inventors by years lived");
console.table(inventorsYearsLived);
...
let peopleAlphabetically = people.sort((a, b) => {
  const [aLast, aFirst] = a.split(', ');
  const [bLast, bFirst] = b.split(', ');
  return aLast > bLast ? 1 : -1;
});
console.log("7. sort Exercise");
console.table(peopleAlphabetically);
